...
export function ChatInterface() {
    ...
    const [isTyping, setIsTyping] = useState(false); // Can be replaced by context isLoading if desired
    ...
    return (
        <div className="flex flex-col h-screen w-full bg-transparent text-white font-sans overflow-hidden">
            {/* Background Effects */}
                                                        ...
                                                        <tbody className="text-white/80">
                                                            {msg.data.map((row, i) => (
                                                                <tr key={i} className="border-t border-white/5 hover:bg-white/5 transition-colors">
                                                                    ...
                                                                    <td className="px-4 py-3 font-mono text-xs opacity-70">{row.phone_number || '-'}</td>
            ...
            <div className="w-full relative z-20 px-6 pb-6 pt-2 bg-gradient-to-t from-black/80 to-transparent">
                <motion.div
                    layout
